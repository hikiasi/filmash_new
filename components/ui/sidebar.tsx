...
>(
  (
    ...
    // We use useControlledState so that the sidebar state can be manipulated by a response.
      ...
      >
        ...
        <div
          className={cn(
            ...
            // Adjust the width of the sidebar based on state.
            state === "collapsed"
...
>(({ className, ...props }, ref) => {
  ...
  return (
    <button
      ...
      className={cn(
        "absolute inset-y-0 z-20 hidden w-4 -translate-x-1/2 transition-all ease-linear after:absolute after:inset-y-0 after:left-1/2 after:w-[2px] hover:after:bg-sidebar-border group-data-[side=left]:-right-4 group-data-[side=right]:-left-4 md:inline-block",
        "[[data-side=left][data-state=collapsed]&]:cursor-w-resize [[data-side=right][data-state=collapsed]&]:cursor-e-resize",
        "[[data-side=left][data-state=expanded]&]:cursor-e-resize [[data-side=right][data-state=expanded]&]:cursor-w-resize",
