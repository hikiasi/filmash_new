        ...
        <div className="max-w-4xl space-y-8">
            <section className="bg-zinc-950 border border-zinc-900 p-10 rounded-[2.5rem] shadow-2xl">
                 ...
                 <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div>
                        <label className="text-[10px] font-black text-zinc-600 uppercase tracking-widest block mb-3">Курс CNY → RUB (ЦБ РФ)</label>
                        <div className="flex items-center gap-4">
                            <input type="text" value="13.52" readOnly className="flex-1 h-14 bg-zinc-900 border border-zinc-800 rounded-2xl px-5 text-zinc-500 font-black italic outline-none" />
                            <button className="h-14 px-6 bg-zinc-900 border border-zinc-800 text-white text-[10px] font-black uppercase tracking-widest rounded-2xl hover:bg-zinc-800 transition-all italic">Обновить</button>
                        </div>
                    </div>
                    <div>
                        <label className="text-[10px] font-black text-zinc-600 uppercase tracking-widest block mb-3">Ручная корректировка</label>
                        <div className="flex items-center gap-4">
                            <input type="text" placeholder="14.00" className="flex-1 h-14 bg-zinc-900 border border-zinc-800 rounded-2xl px-5 text-white font-black italic outline-none focus:border-primary" />
                            <button className="h-14 px-8 bg-primary text-black text-[10px] font-black uppercase tracking-widest rounded-2xl hover:opacity-90 transition-all italic shadow-lg shadow-primary/10">Применить</button>
                        </div>
                    </div>
                 </div>
            </section>
