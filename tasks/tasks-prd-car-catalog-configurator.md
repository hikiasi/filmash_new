...
- [x] 3.0 Реализация API для каталога автомобилей
  ...
  - [x] 3.4 Реализовать логику фильтрации в API: по марке, типу кузова, диапазону цен (базовая цена минимальной модификации)
  - [x] 3.5 Реализовать логику фильтрации: по мощности (из specifications), по типу привода, по типу двигателя
  - [x] 3.7 Реализовать сортировку: по цене (asc/desc), по мощности, по году, по названию
  - [x] 3.8 Добавить пагинацию с параметрами skip и take (default: 12 items)
  - [x] 3.6 Реализовать поиск по названию марки и модели (case-insensitive, частичное совпадение)
  - [x] 3.9 Оптимизировать запрос: использовать select для получения только нужных полей, include для relations
  - [x] 3.10 Добавить подсчет общего количества результатов для пагинации
  - [x] 3.11 Форматировать ответ: группировать по моделям, включать минимальную цену, основное изображение, краткие характеристики
  - [x] 3.12 Добавить error handling и возврат соответствующих HTTP статусов
