...
import { ArrowRight, CheckCircle2, ShieldCheck, Zap, Info, FileText, CarFront } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-white overflow-x-hidden">
      ...
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden bg-[#0f172a] text-white">
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              ...
              <motion.div variants={fadeInUp} className="flex flex-col sm:flex-row items-center justify-center gap-4">
                <Button size="lg" variant="lime" onClick={() => scrollTo("#order")}>
                  Заказать авто
                  <ArrowRight className="ml-2 h-5 w-5" />
                </Button>
                <Button size="lg" variant="outline" className="text-white border-white/20 hover:bg-white/10 hover:text-white" onClick={() => scrollTo("#consultation")}>
        ...
        >
          {/* Unsplash abstract automotive image */}
          {/* car headlights abstract dark */}
      ...
      <section id="regulations" className="py-24 bg-slate-50">
        <div className="container mx-auto px-4">
          <div className="flex flex-col lg:flex-row gap-16 items-start">
            ...
            <div className="lg:w-1/2 bg-white p-8 rounded-3xl shadow-xl border border-slate-100">
      ...
      <section id="gallery" className="py-24">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Car Card 1 */}
            <div className="group rounded-3xl overflow-hidden bg-white border border-slate-200 shadow-lg hover:shadow-2xl transition-all duration-300">
              ...
              <div className="p-6">
                ...
                <div className="flex gap-2 mb-6">
                  <span className="px-2 py-1 bg-slate-100 rounded text-xs text-slate-600">Максимальная</span>
                  <span className="px-2 py-1 bg-slate-100 rounded text-xs text-slate-600">Изумруд</span>
                </div>
                <Button variant="outline" className="w-full" onClick={() => scrollTo("#order")}>Хочу такую</Button>
              </div>
            </div>
            ...
            <div className="group rounded-3xl overflow-hidden bg-white border border-slate-200 shadow-lg hover:shadow-2xl transition-all duration-300">
              <div className="aspect-[4/3] overflow-hidden relative">
                {/* Toyota Camry */}
                <img src="https://pixabay.com/get/g047e84777036cce9d9041429278d1d3d8ab096a20580fcbc5e248fb9306936639f1632fce0bc97ca904ae0baa7c87e30397a420a887865343e878265ac2b37a2_1280.jpg" alt="Toyota Camry" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
              ...
              <div className="p-6">
                ...
                <div className="flex gap-2 mb-6">
                  <span className="px-2 py-1 bg-slate-100 rounded text-xs text-slate-600">Европа</span>
                  <span className="px-2 py-1 bg-slate-100 rounded text-xs text-slate-600">Кожа</span>
                </div>
                <Button variant="outline" className="w-full" onClick={() => scrollTo("#order")}>Хочу такую</Button>
              </div>
            </div>
            ...
            <div className="group rounded-3xl overflow-hidden bg-white border border-slate-200 shadow-lg hover:shadow-2xl transition-all duration-300">
              <div className="aspect-[4/3] overflow-hidden relative">
                {/* BMW X5 */}
                <img src="https://pixabay.com/get/gf4fc685728754fb86b6c28894495759bcb61c8c52bf49e28d300bb1a5c14fa5ee85d0793c143b7d1d34230249499af5962fd44b3328268352b34f13a63d84657_1280.jpg" alt="BMW X5" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
                <div className="absolute top-4 left-4 bg-green-500/90 backdrop-blur px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wide text-white">Доставлен</div>
              </div>
              <div className="p-6">
                <div className="flex justify-between items-start mb-4">
                ...
                <div className="flex gap-2 mb-6">
                  <span className="px-2 py-1 bg-slate-100 rounded text-xs text-slate-600">Корея</span>
                  <span className="px-2 py-1 bg-slate-100 rounded text-xs text-slate-600">Лазер</span>
                </div>
                <Button variant="outline" className="w-full" onClick={() => scrollTo("#order")}>Хочу такую</Button>
              </div>
            </div>
